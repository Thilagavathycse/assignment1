...
def largest_planet(Mercury,Venus,Earth,Mars,Jupiter,Saturn,Uranus,Neptune):
    largest=max(Mercury.diameter,Venus.dimater,Earth.diameter,Mars.diamter,Jupiter.diamter,Saturn.diamter,Uranus.diamter,Neptune.diamter)
    print(largest)
    for largest in (Mercury.diameter,Venus.dimater,Earth.diameter,Mars.diamter,Jupiter.diamter,Saturn.diamter,Uranus.diamter,Neptune.diamter):
        for j in (Mercury.planet,Venus.planet,Earth.planet,Mars.planet,Jupiter.planet,Saturn.planet,Uranus.planet,Neptune.planet):
            if largest == j:
                print(j)
